...
# python library used for webscraping to extract article text from url from html and xml files.Install bs4 and import this in file to make the efficient use of it.
...
class data_extraction:        
    ...
    def primary(self):
        try:
            data = pd.read_excel(os.path.join("C:\\Users\\HP\\Desktop\\BlackCoffer\\data","Input.xlsx"))  
            return data
    ...
    def secondary(self):
        ...
        data = pd.read_excel('C:\\Users\\HP\\Desktop\\BlackCoffer\\data\\Input.xlsx')
        ...
        for i, url in enumerate(df['URL']):
            ...
            file_path = 'C:\\Users\\HP\\Desktop\\BlackCoffer\\TextFiles' #Path to store text files
            space = " "
    ...
    def Handle_Blank_link(self,blank_data): # same as above method but this method is used for extracting those text which are not extracted by secondary method
        updated_list = []
        ...
        for item in blank_data:
            ...
            if alldiv is not None:
                ...
                file_path = 'C:\\Users\\HP\\Desktop\\BlackCoffer\\TextFiles'
                space = " "                
    ...
    def merged(self,df1,df2): #
        ...
        merged_df.to_csv('C:\\Users\\HP\\Desktop\\BlackCoffer\\data\\final.csv', index=False) # dataframe is saved in csv format
        return merged_df